...
*/
typedef tuple<FullObjectPath, bool exists, string error> ObjectsExistResult;

funcdef objects_exist(objects_exist_params input) returns (list<ObjectsExistResult> output) authentication optional;
