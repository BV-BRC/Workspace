...
our %return_counts = (
        'create_workspace' => 1,
        'save_objects' => 1,
        'create_upload_node' => 1,
        'get_objects' => 1,
        'get_workspace_meta' => 1,
        'get_objects_by_reference' => 1,
        'list_workspace_contents' => 1,
        'list_workspace_hierarchical_contents' => 1,
        'list_workspaces' => 1,
        'search_for_workspaces' => 1,
        'search_for_workspace_objects' => 1,
        'create_workspace_directory' => 1,
        'copy_objects' => 1,
        'move_objects' => 1,
        'delete_workspace' => 1,
        'delete_objects' => 1,
        'delete_workspace_directory' => 1,
        'reset_global_permission' => 1,
        'set_workspace_permissions' => 1,
        'list_workspace_permissions' => 1,
        'version' => 1,
);

our %method_authentication = (
        'create_workspace' => 'required',
        'save_objects' => 'required',
        'create_upload_node' => 'required',
        'get_objects' => 'required',
        'get_workspace_meta' => 'required',
        'get_objects_by_reference' => 'required',
        'list_workspace_contents' => 'required',
        'list_workspace_hierarchical_contents' => 'required',
        'list_workspaces' => 'required',
        'search_for_workspaces' => 'required',
        'search_for_workspace_objects' => 'required',
        'create_workspace_directory' => 'required',
        'copy_objects' => 'required',
        'move_objects' => 'required',
        'delete_workspace' => 'required',
        'delete_objects' => 'required',
        'delete_workspace_directory' => 'required',
        'reset_global_permission' => 'required',
        'set_workspace_permissions' => 'required',
        'list_workspace_permissions' => 'required',
);
...
sub call_method {
    ...
    my $ctx = Bio::P3::Workspace::ServiceContext->new($self->{loggers}->{userlog},
