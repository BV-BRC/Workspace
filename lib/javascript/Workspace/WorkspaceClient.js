...
function Workspace(url, auth, auth_cb) {
    ...
    this.save_objects = function (arg_1, _callback, _errorCallback) {
    return json_call_ajax("Workspace.save_objects",
        [arg_1], 1, _callback, _errorCallback);
};

    this.save_objects_async = function (arg_1, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.save_objects", [arg_1], 1, _callback, _error_callback);
    };

    this.create_upload_node = function (arg_1, _callback, _errorCallback) {
    return json_call_ajax("Workspace.create_upload_node",
        [arg_1], 1, _callback, _errorCallback);
};

    this.create_upload_node_async = function (arg_1, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.create_upload_node", [arg_1], 1, _callback, _error_callback);
    };
    ...
    this.search_workspaces = function (queries, _callback, _errorCallback) {
    return json_call_ajax("Workspace.search_workspaces",
        [queries], 1, _callback, _errorCallback);
};

    this.search_workspaces_async = function (queries, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.search_workspaces", [queries], 1, _callback, _error_callback);
    };
    ...
    this.copy_objects = function (arg_1, _callback, _errorCallback) {
    return json_call_ajax("Workspace.copy_objects",
        [arg_1], 1, _callback, _errorCallback);
};

    this.copy_objects_async = function (arg_1, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.copy_objects", [arg_1], 1, _callback, _error_callback);
    };

    this.move_objects = function (arg_1, _callback, _errorCallback) {
    return json_call_ajax("Workspace.move_objects",
        [arg_1], 1, _callback, _errorCallback);
};

    this.move_objects_async = function (arg_1, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.move_objects", [arg_1], 1, _callback, _error_callback);
    };
