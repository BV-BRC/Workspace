...
function Workspace(url, auth, auth_cb) {
    ...
    this.objects_exist = function (input, _callback, _errorCallback) {
    return json_call_ajax("Workspace.objects_exist",
        [input], 1, _callback, _errorCallback);
};

    this.objects_exist_async = function (input, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.objects_exist", [input], 1, _callback, _error_callback);
    };
    ...
    this.du = function (input, _callback, _errorCallback) {
    return json_call_ajax("Workspace.du",
        [input], 1, _callback, _errorCallback);
};

    this.du_async = function (input, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.du", [input], 1, _callback, _error_callback);
    };
